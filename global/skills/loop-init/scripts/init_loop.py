...
Use the smallest useful record for the active task. Keep active requirements and status separate from historical decisions, evaluations, hashes, and logs. Do not store secrets, credentials, or private configuration.
""",
