...
- Keep the worker ephemeral, approval-free, and pinned to `gpt-5.6-sol` with `model_reasoning_effort="max"`. Never substitute `ultra`, another model, or another authentication path.
